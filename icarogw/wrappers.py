...
from .cosmology import alphalog_astropycosmology, cM_astropycosmology, extraD_astropycosmology, Xi0_astropycosmology, astropycosmology, eps0_astropycosmology, w0waOEFT_astropycosmology
...
class massprior_Gaussian(pm_prob):
    def __init__(self):
        self.population_parameters=['mu_g','sigma_g']
    def update(self,**kwargs):
        self.prior=TruncatedGaussian(kwargs['mu_g'],kwargs['sigma_g'], max(0, kwargs['mu_g'] - 5*kwargs['sigma_g']), kwargs['mu_g'] + 5*kwargs['sigma_g'])
